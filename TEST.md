...
* Specific to Level-2A (L2A) products, various optional water indexes are offered:  
  ...
  By leveraging raster function chains for this, the index calculation is performed on-the-fly. The respective function chain declaration is fully script-generated and allows for individual modifications, for example to simply adjust an index threshold value (offset), or to extensively modify a formula's arithmetic expression, or to quickly implement your very own index.
