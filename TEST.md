...
#### Characteristics
* :new: ArcGIS 10.6 now provides L2A function templates with its built-in Sentinel-2 raster product type, whereof the "BOA reflectance-10m" template is added to a L2A Group Layer:  
