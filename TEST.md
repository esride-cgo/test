...
* Beginning with ArcGIS 10.5.1, the newer version (>=14) of the Products Specification Document (PSD) is now supported in terms of a built-in raster product. With ArcGIS version lower than 10.5.1, ArcGIS lacks such a support – as a substitute for this, the natural color composite (TCI) is used for the _Download_ tool output parameter.
