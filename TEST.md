...
#### Characteristics
* For Level-2A (L2A) products, the newer version (>=14.5) of the Products Specification Document (PSD) that has been introduced with the [operational](https://scihub.copernicus.eu/news/News00305) distribution of L2A products is taken into account.
